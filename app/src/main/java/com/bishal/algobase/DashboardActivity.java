...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Add menu items
        bottomNavigation.add(new MeowBottomNavigation.Model(1,R.drawable.datastrucuture_vector));
        bottomNavigation.add(new MeowBottomNavigation.Model(2,R.drawable.algorithm_vector));
        bottomNavigation.add(new MeowBottomNavigation.Model(3,R.drawable.study_material_vector));
